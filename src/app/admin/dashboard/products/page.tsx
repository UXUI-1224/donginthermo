  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/admin/products', {
        ...
        body: JSON.stringify({ name: name.trim(), category, tagline: tagline.trim(), features: [] }),
      })
          ...
          <div>
            ...
            {preview ? (
              <div className="relative group inline-block mb-2">
                ...
                <img src={preview} alt="" className="w-28 h-20 object-cover rounded-lg border border-gray-100" />
                <button
                  onClick={clearFile}
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100">
          {confirmDelete ? (
            <div className="flex items-center gap-2">
              <span className="text-xs text-red-500 font-medium">Delete this product?</span>
              <button
